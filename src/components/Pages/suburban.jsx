...
import "../Styles/suburban.scss";
import Suburban from "../Image/Chevrolet-Suburban.png";
  ...
  return (
    <div>
      <div className="product-img">
        <img src={Suburban} alt="lincoln" width={420} height={300} />
        <div className="product-desc">
          <h1>Chevrolet Suburban</h1>
          <p>
            Chevy Suburban has sleek body lines and chrome body accents make it
            stand out from the crowd! It has quite a presence with its V8 motor
            as well as a luxurious leather interior. Enjoy a limousine with the
            latest luxuries to set the mood for any special occasion.
          </p>
